    ...
    return LaunchDescription([
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"root_component_id":"69c199b7765e0a0204792a11","end_effector_component_id":"69c199d1765e0a0204792a4c","components":[],"joints":[],"max_iterations":100,"tolerance":0.001,"damping":0.01}')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"joint_id":"69c199c3765e0a0204792a2d","transport":"can","units":"radians","gear_ratio":1,"smoothing_alpha":0,"can.node_id":0,"can.interface":"socketcan","can.channel":"can0","can.bitrate":1000000,"can.poll_hz":50,"can.request_iq":false,"can.heartbeat_timeout_s":2,"can.enable_closed_loop_on_start":true,"can.torque_constant":0,"limit.lower_position":-180,"limit.upper_position":180,"limit.position_step":1,"limit.max_effort":50,"limit.effort_step":0.5,"limit.max_velocity":180,"limit.velocity_step":1}')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"joint_id":"69c199ca765e0a0204792a37","transport":"can","units":"radians","gear_ratio":1,"smoothing_alpha":0,"can.node_id":0,"can.interface":"socketcan","can.channel":"can0","can.bitrate":1000000,"can.poll_hz":50,"can.request_iq":false,"can.heartbeat_timeout_s":2,"can.enable_closed_loop_on_start":true,"can.torque_constant":0,"limit.lower_position":-180,"limit.upper_position":180,"limit.position_step":1,"limit.max_effort":50,"limit.effort_step":0.5,"limit.max_velocity":180,"limit.velocity_step":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":"/robot/base","rate_hz":150,"lifecycle":true}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69b5b247145f6cae225f9da5:state","name":"state","direction":"output","msg_type":"sensor_msgs/JointState"},{"pin_id":"69b5b247145f6cae225f9da5:trajectory","name":"trajectory","direction":"input","msg_type":"trajectory_msgs/JointTrajectoryPoint"},{"pin_id":"69b5b247145f6cae225f9da5:mode","name":"mode","direction":"input","msg_type":"std_msgs/String"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"joint_id":"69c199cd765e0a0204792a41","transport":"can","units":"radians","gear_ratio":1,"smoothing_alpha":0,"can.node_id":0,"can.interface":"socketcan","can.channel":"can0","can.bitrate":1000000,"can.poll_hz":50,"can.request_iq":false,"can.heartbeat_timeout_s":2,"can.enable_closed_loop_on_start":true,"can.torque_constant":0,"limit.lower_position":-180,"limit.upper_position":180,"limit.position_step":1,"limit.max_effort":50,"limit.effort_step":0.5,"limit.max_velocity":180,"limit.velocity_step":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":"/robot/base","rate_hz":150,"lifecycle":true}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69b5b247145f6cae225f9da5:state","name":"state","direction":"output","msg_type":"sensor_msgs/JointState"},{"pin_id":"69b5b247145f6cae225f9da5:trajectory","name":"trajectory","direction":"input","msg_type":"trajectory_msgs/JointTrajectoryPoint"},{"pin_id":"69b5b247145f6cae225f9da5:mode","name":"mode","direction":"input","msg_type":"std_msgs/String"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"joint_id":"69c199bc765e0a0204792a19","transport":"can","units":"radians","gear_ratio":1,"smoothing_alpha":0,"can.node_id":0,"can.interface":"socketcan","can.channel":"can0","can.bitrate":1000000,"can.poll_hz":50,"can.request_iq":false,"can.heartbeat_timeout_s":2,"can.enable_closed_loop_on_start":true,"can.torque_constant":0,"limit.lower_position":-180,"limit.upper_position":180,"limit.position_step":1,"limit.max_effort":50,"limit.effort_step":0.5,"limit.max_velocity":180,"limit.velocity_step":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":"/robot/base","rate_hz":150,"lifecycle":true}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69b5b247145f6cae225f9da5:state","name":"state","direction":"output","msg_type":"sensor_msgs/JointState"},{"pin_id":"69b5b247145f6cae225f9da5:trajectory","name":"trajectory","direction":"input","msg_type":"trajectory_msgs/JointTrajectoryPoint"},{"pin_id":"69b5b247145f6cae225f9da5:mode","name":"mode","direction":"input","msg_type":"std_msgs/String"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"joint_id":"69c199b7765e0a0204792a10","transport":"can","units":"radians","gear_ratio":1,"smoothing_alpha":0,"can.node_id":0,"can.interface":"socketcan","can.channel":"can0","can.bitrate":1000000,"can.poll_hz":50,"can.request_iq":false,"can.heartbeat_timeout_s":2,"can.enable_closed_loop_on_start":true,"can.torque_constant":0,"limit.lower_position":-180,"limit.upper_position":180,"limit.position_step":1,"limit.max_effort":50,"limit.effort_step":0.5,"limit.max_velocity":180,"limit.velocity_step":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":"/robot/base","rate_hz":150,"lifecycle":true}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69b5b247145f6cae225f9da5:state","name":"state","direction":"output","msg_type":"sensor_msgs/JointState"},{"pin_id":"69b5b247145f6cae225f9da5:trajectory","name":"trajectory","direction":"input","msg_type":"trajectory_msgs/JointTrajectoryPoint"},{"pin_id":"69b5b247145f6cae225f9da5:mode","name":"mode","direction":"input","msg_type":"std_msgs/String"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"joint_id":"69c199bf765e0a0204792a23","transport":"can","units":"radians","gear_ratio":1,"smoothing_alpha":0,"can.node_id":0,"can.interface":"socketcan","can.channel":"can0","can.bitrate":1000000,"can.poll_hz":50,"can.request_iq":false,"can.heartbeat_timeout_s":2,"can.enable_closed_loop_on_start":true,"can.torque_constant":0,"limit.lower_position":-180,"limit.upper_position":180,"limit.position_step":1,"limit.max_effort":50,"limit.effort_step":0.5,"limit.max_velocity":180,"limit.velocity_step":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":"/robot/base","rate_hz":150,"lifecycle":true}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69b5b247145f6cae225f9da5:state","name":"state","direction":"output","msg_type":"sensor_msgs/JointState"},{"pin_id":"69b5b247145f6cae225f9da5:trajectory","name":"trajectory","direction":"input","msg_type":"trajectory_msgs/JointTrajectoryPoint"},{"pin_id":"69b5b247145f6cae225f9da5:mode","name":"mode","direction":"input","msg_type":"std_msgs/String"}]')),
